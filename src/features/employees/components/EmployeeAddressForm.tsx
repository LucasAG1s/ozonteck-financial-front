...
import { IEmployee as Employee, IEmployeeAddress as EmployeeAddressType  } from '@/interfaces/HR/EmployeeInterface';
import { updateEmployeeAddress  } from '@/lib/services/hr/employees.service';
